            ...
            <el-card style="padding: 0">
                <el-radio-group v-model="radio1" size="medium" @change="changeShop">
                    <div v-for='(item, index) in sanplData' style='display: inline-block' :key='index'>
                        <el-tooltip placement="top" :content='item.offerId' open-delay='500'>
            ...
            <el-card shadow="hover" class="card1" style="width: 65%">
                <div class="score-box">
                    <div class="score-info" style="width: 67%">
                        ...
                        <div class="score-num">
                            <span class="score">{{ weekLineChartData.riskReportV3ShopScore.scoreSum || '0' }}</span>
...
export default {
    ...
    methods: {
        changeShop(index) {
            console.log(this.allweekLineChartData);
