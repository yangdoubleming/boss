            ...
            <el-card style="padding: 0">
                <el-radio-group v-model="radio1" size="medium" @change="changeShop">
                    <div v-for="(item, index) in sanplData" style="display: inline-block" :key="index">
                        <el-tooltip placement="top" :content="item.offerId">
                    ...
                    <div class="score-info" style="width: 67%">
                        ...
                        <div class="score-num">
                            ...
                            <span class="history-score">
                                <i v-if="Number(itemData.currSellerScore - itemData.lastSellerScore) > 0"
                                    class="el-icon-top"></i>
                                <i v-else class="el-icon-bottom"></i>
                                {{ (itemData.currSellerScore - itemData.lastSellerScore).toFixed(2) }}
                            </span>
                        </div>
                        <div class="score-time">{{ $t('loan_detail_gxsj') }}：{{ itemData.reportDate || '-' }}</div>
                    </div>
...
export default {
    ...
    methods: {
        changeShop(index) {
            console.log('allweek', this.allweekLineChartData);
        ...
        getWeekChants(index) {
            ...
            this.scoreSum = newV.scoreSum ? newV.scoreSum : this.scoreSum;
            let hegui =
                Number(newV.warnOrderScore ? newV.warnOrderScore : 0) +
                Number(newV.cancelOrderScore ? newV.cancelOrderScore : 0) +
                Number(newV.defectOrderScore ? newV.defectOrderScore : 0) +
                Number(newV.lateOrderScore ? newV.lateOrderScore : 0) +
                Number(newV.returnOrderScore ? newV.returnOrderScore : 0);
            let pingjia =
                Number(newV.negFeedbackScore ? newV.negFeedbackScore : 0) + Number(newV.feedbackOrderScore ? newV.feedbackOrderScore : 0);
            let kucun = Number(newV.latestfbaScore ? newV.latestfbaScore : 0) + Number(newV.turnsScore ? newV.turnsScore : 0);
            let zengzhang =
                Number(newV.ysalesGrowthScore ? newV.ysalesGrowthScore : 0) + Number(newV.msalesGrowthScore ? newV.msalesGrowthScore : 0);
            let huikuan =
                Number(newV.ydisGrowthScore ? newV.ydisGrowthScore : 0) +
                Number(newV.mdisGrowthScore ? newV.mdisGrowthScore : 0) +
                Number(newV.disRatioScore ? newV.disRatioScore : 0);
        ...
        getOfferInfo(index) {
            ...
            this.itemData.currSellerScore = this.itemData.currSellerScore ? this.itemData.currSellerScore : 0;
            if (this.itemData.shopMetricsVoMap.shop) {
                ...
                this.tableData[0].val1 = 0 + '%';
                this.tableData[1].val1 = 0 + '%';
                this.tableData[2].val1 = 0 + '%';
                this.tableData[3].val1 = 0 + '%';
                this.tableData[4].val1 = 0 + '%';
                this.tableData[5].val1 = 0 + '%';
            }
            ...
            if (this.itemData.shopMetricsVoMap.industry) {
                ...
                this.tableData[0].val2 = 0 + '%';
                this.tableData[1].val2 = 0 + '%';
                this.tableData[2].val2 = 0 + '%';
                this.tableData[3].val2 = 0 + '%';
                this.tableData[4].val2 = 0 + '%';
                this.tableData[5].val2 = 0 + '%';
            }
            ...
            if (this.itemData.shopMetricsVoMap.allIndustry) {
                ...
                this.tableData[0].val3 = 0 + '%';
                this.tableData[1].val3 = 0 + '%';
                this.tableData[2].val3 = 0 + '%';
                this.tableData[3].val3 = 0 + '%';
                this.tableData[4].val3 = 0 + '%';
                this.tableData[5].val3 = 0 + '%';
            }
            ...
            if (this.itemData.shopMetricsVoMap.allIndustryRanking) {
                ...
                this.tableData[0].val4 = 0 + '%';
                this.tableData[1].val4 = 0 + '%';
                this.tableData[2].val4 = 0 + '%';
                this.tableData[3].val4 = 0 + '%';
                this.tableData[4].val4 = 0 + '%';
                this.tableData[5].val4 = 0 + '%';
            }
            ...
            if (this.itemData.shopMetricsVoMap.allSiteRanking) {
                ...
                this.tableData[0].val6 = 0 + '%';
                this.tableData[1].val6 = 0 + '%';
                this.tableData[2].val6 = 0 + '%';
                this.tableData[3].val6 = 0 + '%';
                this.tableData[4].val6 = 0 + '%';
                this.tableData[5].val6 = 0 + '%';
            }
