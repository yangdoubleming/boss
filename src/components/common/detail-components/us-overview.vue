            ...
            <el-card shadow="hover" class="card2" style="padding-left: 0px;">
                ...
                <div class="order-info">
                    <div class="money">
                        ...
                        <span class="money-title">{{ $t('loan_detail_kzyje') }}</span>
                        <span class="money-num" style="margin-bottom:10px">
                            <span style="padding-right:5px">¥</span>
                            {{ (totalData.availableAmount / 10000).toFixed(2) || '-' }}
                        </span>
        ...
        <div style="display:flex; justify-content: space-between;">
            ...
            <div class="card4">
                <el-card shadow="hover" class="card1 card4" style="width:100%">
                    <span class="score-title" style="margin-bottom:0px;">{{ $t('loan_detail_sydpjgyxs') }}</span>
...
import { clearLoan, companyAll, loanSave, deleteLoan,deleteForOverview } from '../../../api/index';
...
export default {
    ...
    methods: {
        ...
        refCharts() {
            ...
            for (let i = 1; i <= 12; i++) {
                this.options2.series[0].data.unshift(this.totalData.dataBoardOfferDTO[`month${i}SalesValue`]);
                this.options2.series[1].data.unshift(this.totalData.dataBoardOfferDTO[`month${i}DisbursementsValue`]);
            }
