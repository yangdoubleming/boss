<template>
    <div>
            ...
            <el-col :span="24">
                <el-row :gutter="24" class="mgb20">
                    ...
                    <!-- <el-col :span="12">
                        ...
                        >
                            <el-button style="float:right" type="primary" icon="el-icon-document-copy" @click="dialogFormVisible=true" v-if="$showBtn('CREATE_APPLICATION')">{{ $t('loan_add_new') }}</el-button>
                        </div>
                    </el-col> -->
                </el-row>
            </el-col>
        ...
        <table-page @onExport="onExport" :tableData="tableData" :showFilterRadio="true" :tableOperate="tableOperate"
            ...
            :filterStatus='filterStatus' :detailTable="true" />
...
import { minecraftList, lenderList, statSum, newOrder, getProducts, providerSelect } from '../../../api/index';
export default {
    name: 'minecraft',
    mixins: [tableMixin],
    components: {
    ...
    methods: {
        ...
        _getList() {
            let starTime = this.filterOptions[3].value.length ? this.filterOptions[3].value[0] : '';
            let endTime = this.filterOptions[3].value.length ? this.filterOptions[3].value[1] : '';
            let data = {
                current: this.currentPage,
                size: 10,
                applicationCode: this.filterOptions[0].value,
                bName: this.filterOptions[1].value,
                bPhoneNumber: this.filterOptions[2].value,
                lenderId: this.filterOptions[3].value,
                applicationStatus: this.applicationStatus,
                applicationTimeStart: starTime,
                applicationTimeEnd: endTime,
                lenderProduct: '跨易赊'
            }
