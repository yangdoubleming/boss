                    ...
                    <div class="title-box" style="align-items: center">
                        ...
                        <div class="right">
                            <el-button
                                type="success"
                                @click="pushOrder"
                                v-if="applicationStatus === '已创建' && $showBtn('US_SUBMIT_LOAN')"
                                >{{ $t('common_submit') }}</el-button
                            >

                            <el-button type="success" @click="openActive" v-if="applicationStatus === '已提交'">审批 </el-button>
                            <el-button type="success" @click="openFile" v-if="pageData.creditContractPath">查看文件 </el-button>
                        </div>
                    </div>
                </el-card>
            </el-col>
        ...
        <el-dialog title="审批" :visible.sync="dialogFormVisible2" width="30%">
            <el-form :inline="true" :model="form" ref="form" style="padding-left: 20px" label-width="150px" label-position="left">
                <el-form-item label="授信起始日期" style="margin-right: 30px" prop="dates">
                    <el-date-picker v-model="activeTime" type="datetime" value-format="yyyy-MM-dd HH:mm:ss"> </el-date-picker>
                </el-form-item>
