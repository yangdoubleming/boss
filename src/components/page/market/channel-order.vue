    ...
    <div>
            ...
            <el-form ref="ruleForm" :model="ruleForm" label-width="85px"
                ...
                <el-row style="display: flex">
                    ...
                    <div class="actionButton">
                        ...
                        <el-button type="primary" @click="exportExcel" v-if="$showBtn('EXCEL_INSURANCE_ORDER')">导出excel</el-button> -->
                    </div>
                </el-row>
            </el-form>
        </el-row>
        <el-row :gutter="24" class="dataList" style="margin-left: 0; margin-right: 0">
            ...
            <el-card shadow="hover" :body-style="{ padding: '0px' }">
                <el-table ref="multipleTable" :row-key="getRowKey" :data="tableData" v-loading="loading"
                    ...
                    <el-table-column prop="placeTime" label="下单时间" align="center" width="100px"> </el-table-column>
        ...
        <el-dialog title="批量投保" :visible.sync="dialogVisible" width="25%" center class="dialog">
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="sureUpload" :disabled="disabled">确 定</el-button>
            </span>
        </el-dialog>
...
import { orderList2, count } from '@/api/insur';
