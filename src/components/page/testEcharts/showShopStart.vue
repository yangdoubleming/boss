                ...
                <div class="bottom-box-cc">
                    <dv-border-box-12 ref="borderOne">
                        <div class=" jc-between px-2">
                            ...
                            <centerLeftCredit1 :allData=allData :riskData="riskData" />
                        </div>
                            ...
                            <dv-border-box-12 ref="borderBox">
                                <div class="select-box" style="padding: 0 20px;">
                                    ...
                                    <div>
                                        ...
                                        <div class="small-txt">{{ allPieDta.leftTime || 'NA' }}——{{ allPieDta.rightTime
                                            ||
                                            'NA' }}</div>
                                    </div>
                                </div>
...
import centerLeftCredit1 from './centerLeftCredit1'
