<template>
    <div>
                        ...
                        <el-row style="display: flex">
                            ...
                            <el-form-item class="timeC">
                                <el-date-picker
                                    ...
                                    type="daterange"
                                    range-separator="-"
                                    start-placeholder="返佣开始时间"
                                    end-placeholder="返佣结束时间"
        ...
        <el-row :gutter="24" class="dataList" style="margin-left: 0; margin-right: 0">
            <div style="margin-bottom: 20px; font-weight: 700; color: #666; font-size: 15px">保险合伙人返佣流水</div>
            <el-card shadow="hover" :body-style="{ padding: '0px' }">
...
<script>
import { getUserAmountLogList, downloadList, getRebateDetailsList } from '@/api/insur';
...
export default {
    ...
    data() {
        return {
            ...
            currentPage: 1
            // baseUrl:'http://10.127.56.10:9013/liebian',
        };
    },
    created() {
        this.getDataList();
    ...
    methods: {
        ...
        exportDetail() {
            ...
            axios({
                method: 'post',
                responseType: 'blob',
                url: `${this.baseUrl}/download/getUserAmountLogListByInsurance`,
                headers: {
        ...
        getDataList() {
            getRebateDetailsList({ data: this.ruleForm, path: '/Insure/getRebateDetailsList' }).then((res) => {
                if (res.code === '200') {
