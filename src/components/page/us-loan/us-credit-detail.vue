        ...
        <el-card>
            ...
            <div
                ...
                <el-form :model="formData" style="" label-width="120px" class="Form" inline>
                    ...
                    <el-form-item label="授信金额/万：">
                        <span class="text">{{ formData.creditAmount }}</span>
                    </el-form-item>
                    ...
                    <el-form-item label="授信状态：">
                        <span class="text">{{ formData.creditStatus }}</span>
                    </el-form-item>

                    <el-form-item label="授信通过时间：">
                        <span class="text">{{ formData.creditApprovalTime }}</span>
                    </el-form-item>
                    <el-form-item label="授信开始时间：">
                        <span class="text">{{ formData.creditStartDate }}</span>
                    </el-form-item>
                    <el-form-item label="授信结束时间：">
                        <span class="text">{{ formData.creditExpireDate }}</span>
                    </el-form-item>
                </el-form>
            </div>
        </el-card>
